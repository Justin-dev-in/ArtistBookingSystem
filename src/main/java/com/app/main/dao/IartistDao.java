...
public interface IartistDao extends JpaRepository<Artist, String>{
	...
	@Query("select b from Artist a ,AdateAvail b where ?1 between  from_date and to_Date and artistfees <=?2 and artist_genre=?3")
	List<Object> checkSearch(Date date,int fees,String genre);
